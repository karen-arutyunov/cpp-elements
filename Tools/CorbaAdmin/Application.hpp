...
/**
 * @file   Elements/Tools/CorbaAdmin/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TOOLS_CORBAADMIN_APPLICATION_HPP_
#define _ELEMENTS_TOOLS_CORBAADMIN_APPLICATION_HPP_
...
private:
  ...
  int stop(const ArgList& arguments)
    throw(InvalidArg, Exception, El::Exception);

  int status(const ArgList& arguments)
    throw(InvalidArg, Exception, El::Exception);
...
#endif // _ELEMENTS_TOOLS_CORBAADMIN_APPLICATION_HPP_
