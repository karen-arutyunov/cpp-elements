...
/**
 * @file   Elements/tests/SharedString/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_SHAREDSTRING_APPLICATION_HPP_
#define _ELEMENTS_TESTS_SHAREDSTRING_APPLICATION_HPP_
...
private:
  ...
  int test_performance(const ArgList& arguments)
    throw(InvalidArg, Exception, El::Exception);

  int test_shared_string(const ArgList& arguments)
    throw(InvalidArg, Exception, El::Exception);
};
...
#endif // _ELEMENTS_TESTS_SHAREDSTRING_APPLICATION_HPP_
