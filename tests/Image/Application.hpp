...
/**
 * @file   Elements/tests/Image/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_IMAGE_APPLICATION_HPP_
#define _ELEMENTS_TESTS_IMAGE_APPLICATION_HPP_
...
private:
  ...
  void image_info(const char* filename) const
    throw(InvalidArg, Exception, El::Exception);
};
...
#endif // _ELEMENTS_TESTS_IMAGE_APPLICATION_HPP_
