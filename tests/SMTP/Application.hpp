...
/**
 * @file   Elements/tests/SMTP/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_SMTP_APPLICATION_HPP_
#define _ELEMENTS_TESTS_SMTP_APPLICATION_HPP_
...
#endif // _ELEMENTS_TESTS_SMTP_APPLICATION_HPP_
