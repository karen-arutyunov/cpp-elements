...
/**
 * @file   Elements/tests/Logger/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_LOGGER_APPLICATION_HPP_
#define _ELEMENTS_TESTS_LOGGER_APPLICATION_HPP_
...
#endif // _ELEMENTS_TESTS_LOGGER_APPLICATION_HPP_
