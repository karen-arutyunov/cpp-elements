...
/**
 * @file   Elements/tests/Sort/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_SORT_APPLICATION_HPP_
#define _ELEMENTS_TESTS_SORT_APPLICATION_HPP_
...
private:
  ...
  void test_different_sorts(const ArgList& arguments)
    throw(InvalidArg, Exception, El::Exception);
  
  void test_taking_top(const ArgList& arguments)
    throw(InvalidArg, Exception, El::Exception);
...
#endif // _ELEMENTS_TESTS_SORT_APPLICATION_HPP_
