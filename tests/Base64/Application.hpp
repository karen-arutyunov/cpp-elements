...
/**
 * @file   Elements/tests/Base64/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_BASE64_APPLICATION_HPP_
#define _ELEMENTS_TESTS_BASE64_APPLICATION_HPP_
...
private:
  ...
  int decode(const ArgList& arguments)
    throw(InvalidArg, Exception, El::Exception);
...
#endif // _ELEMENTS_TESTS_BASE64_APPLICATION_HPP_
