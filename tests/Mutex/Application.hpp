...
/**
 * @file   Elements/tests/Mutex/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_MUTEX_APPLICATION_HPP_
#define _ELEMENTS_TESTS_MUTEX_APPLICATION_HPP_
...
#endif // _ELEMENTS_TESTS_MUTEX_APPLICATION_HPP_
