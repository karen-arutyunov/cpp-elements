...
/**
 * @file   Elements/tests/Moment/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_MOMENT_APPLICATION_HPP_
#define _ELEMENTS_TESTS_MOMENT_APPLICATION_HPP_
...
#endif // _ELEMENTS_TESTS_MOMENT_APPLICATION_HPP_
