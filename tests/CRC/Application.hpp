...
/**
 * @file   Elements/tests/CRC/Application.hpp
 * @author Karen Arutyunov
 * $Id:$
 */

#ifndef _ELEMENTS_TESTS_CRC_APPLICATION_HPP_
#define _ELEMENTS_TESTS_CRC_APPLICATION_HPP_
...
#endif // _ELEMENTS_TESTS_CRC_APPLICATION_HPP_
